...
const runtimePaths = {
  autoInstallComponents: require.resolve('./runtime/autoInstallComponents')
}
...
function install (install, content, imports) {
  if (imports.length) {
    let newContent = '/* vue-automatic-import-loader */\n'
...
module.exports = async function (content, sourceMap) {
  ...
  if (!this.resourceQuery) {
    ...
    content = install('autoInstallComponents', content, getMatches.call(this, 'Tag', tags, options.match, component))
  }
